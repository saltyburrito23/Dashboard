...
def load_settings() -> Settings:
    return Settings(
        ...
        default_strike_count=_int_env("DEFAULT_STRIKE_COUNT", 50),
        default_refresh_seconds=_int_env("DEFAULT_REFRESH_SECONDS", 30),
        default_expiry_chart_max_dte=_int_env("DEFAULT_EXPIRY_CHART_MAX_DTE", 90),
